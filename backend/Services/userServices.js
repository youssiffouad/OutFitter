...
//function to add new piece of clothes
const addNewPiece = async (
  ...
  try {
    ...
    const newClothes = await Clothes.create({
      ...
      photo: "", // Temporary placeholder for the photo URL
      favourite: false,
    });
    ...
    // Update the record with the correct photo URL
    newClothes.photo = newFileName;
